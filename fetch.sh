...
curl -sg -H 'Authorization: Bearer 8VnQ3mOjbj6arh_XBR4Pwv1cHdUZsyRr-552YTOl7ECffjPxRss' 'https://api.pandascore.co/leagues/league-of-legends-lec/matches?filter[finished]=false&sort=begin_at' >> test.json
